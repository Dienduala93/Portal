        ...
        <div class="col-md-12">
           <!-- <h1 class="text-left"> Html::encode($this->title) ?></h1>-->
            <?php if (isset($model->imagen)) { ?>
                <?php echo Html::img('@web/'.$model->ruta.$model->imagen, ['alt' => 'Imagen', 'width' => '250px', 'height' => '250px']) ?>
            <?php } ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <?= ((Yii::$app->user->id===1) ? Html::a('Modificar', ['update-css', 'id' => $model->id], ['class' => 'btn btn-primary']) : null);?>
                    <?= ((Yii::$app->user->id===1) ? Html::a('Eliminar', ['delete-css', 'id' => $model->id],[
