        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12" style="margin-bottom: 10px;">
                    <?= ((Yii::$app->user->id===1) ? Html::a('Modificar', ['update-centrifuga', 'id' => $model->id], ['class' => 'btn btn-primary']) : null);?>
                    <?= ((Yii::$app->user->id===1) ? Html::a('Eliminar', ['delete-centrifuga', 'id' => $model->id],[
