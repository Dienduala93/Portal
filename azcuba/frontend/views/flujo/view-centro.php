...
$this->title = 'Flujo Productivo ';
//$this->params['breadcrumbs'][] = ['label' => 'Flujo Productivo', 'url' => ['centro']];
//$this->params['breadcrumbs'][] = $this->title;
\yii\web\YiiAsset::register($this);
?>
<div class="areaagricola-view panel panel-default col-md-12">
    <div class="row panel-body">
        <div class="col-md-12">
            ...
            <div style="width: 250px;">
                <p class="text-justify" style="margin-top: 10px; height:inherit;font-weight: 700">
                    <?= $model->descripcion ?>
                </p>
            </div>
            <div class="row">
                <div class="col-md-12" style="margin-bottom: 10px;">
                    ...
                    <?= (Yii::$app->user->id===1) ? Html::a('Eliminar', ['delete-centro', 'id' => $model->id],[
