    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div style="width: 250px;">
                <p class="text-justify container" style="margin-top: 10px; height:inherit;">
                    <?= $model->descripcion ?>
                </p>
            </div>
            <div class="row">
                <div class="col-md-12" style="margin-bottom: 10px;">
                    <?= ((Yii::$app->user->id===1) ? Html::a('Modificar', ['update-derivados', 'id' => $model->id], ['class' => 'btn btn-primary']) : null);?>
                    <?= ((Yii::$app->user->id===1) ? Html::a('Eliminar', ['delete-derivados', 'id' => $model->id],[
