...
//$this->params['breadcrumbs'][] = ['label' => 'Laboratório', 'url' => ['laboratorio']];
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12" style="margin-bottom: 10px;">
                    <?= ((Yii::$app->user->id===1) ? Html::a('Modificar', ['update-laboratorio', 'id' => $model->id], ['class' => 'btn btn-primary']) : null);?>
                    <?= ((Yii::$app->user->id===1) ? Html::a('Eliminar', ['delete-laboratorio', 'id' => $model->id],[
